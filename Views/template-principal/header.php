...
<head>
  <title><?php echo TITLE . ' - ' . $data['title']; ?>Free</title>
  ...
  <meta name="msapplication-TileImage" content="<?php echo BASE_URL; ?>assets/favicon/favicon-16x16.png">
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
        ...
        <div class="navbar align-self-center d-flex">
          ...
          <a class="nav-icon position-relative text-decoration-none" href="href="<?php echo BASE_URL.'principal/deseo'?>>
