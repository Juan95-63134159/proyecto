...
<?php include_once 'Views/template-principal/header.php'; ?><?php include_once 'Views/template-principal/header.php'; ?>
    <!-- Open Content -->
    ...
    <!-- End Article -->
    <?php include_once 'Views/template-principal/footer.php'; ?><?php include_once 'Views/template-principal/footer.php'; ?>
